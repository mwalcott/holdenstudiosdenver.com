...
+function ($) {
    ...
    this.backdrop(function () {
      ...
      transition ?
        that.$element.find('.modal-dialog') // wait for modal to slide in
          .one($.support.oriontransition.end, function () {
  ...
  Modal.prototype.enforceFocus = function () {
    $(document)
      ...
      .on('focusin.orion.modal', $.proxy(function (e) {
  ...
  Modal.prototype.escape = function () {
    if (this.isShown && this.options.keyboard) {
      this.$element.on('keyup.dismiss.orion.modal', $.proxy(function (e) {
  ...
  Modal.prototype.backdrop = function (callback) {
    ...
    if (this.isShown && this.options.backdrop) {
      ...
      this.$element.on('click.dismiss.orion.modal', $.proxy(function (e) {
  ...
  $(document).on('click.orion.modal.data-api', '[data-toggle="o-modal"]', function (e) {
    var $this   = $(this)
  ...
  $(document)
    .on('show.orion.modal', '.modal', function () { $(document.body).addClass('modal-open') })
    .on('hidden.orion.modal', '.modal', function () { $(document.body).removeClass('modal-open') })
...
+function ($) {
  ...
  $.fn.emulateTransitionEnd = function (duration) {
    ...
    $(this).one($.support.oriontransition.end, function () { called = true })
    var callback = function () { if (!called) $($el).trigger($.support.oriontransition.end) }
