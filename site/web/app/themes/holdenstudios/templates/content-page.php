...
<?php } else { ?>
	...
	if (strpos($url,'2187') !== false) {
		...
		echo '<p class="wedding-text" style="text-align: center;">Our exceptional service, quality products, and attention to every detail are what have made Holden Studios Colorado’s number one resource for hand - crafted, hand burned, hand stained wedding guestbook flags. Each flag is coated with an outdoor finish and ready to hang. Want your own design added? Give us a call and we will get it exactly the way you want it for memories to last a lifetime.</p><p>If desired, you can ask your guests to sign the back with standard sharpie.” After ready to hang.</p>';
